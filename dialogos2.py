...
# Pastas específicas por tipo
PASTA_POR_TIPO = {
    "dicionario": "Dicionário",
    "pergunta_resposta": "PerguntaseRespostas",
    "iteracao": "Iteração",
    "artigo": "Artigo",
    "conto": "Conto",
    "dialogo_profundo": "Profundo",
...
PASTA_FALLBACKS = os.path.join(PASTA_SAIDA, "Fallbacks")

# Criar todas as pastas
for pasta in [PASTA_SAIDA, PASTA_DADOS_CURTOS, PASTA_DADOS_LONGOS, PASTA_LOGS,
              PASTA_DESCARTES, PASTA_ESTADO, PASTA_CACHE, PASTA_FALLBACKS]:
    os.makedirs(pasta, exist_ok=True)

for subpasta in PASTA_POR_TIPO.values():
    caminho = os.path.join(PASTA_SAIDA, subpasta)
    os.makedirs(caminho, exist_ok=True)

# Arquivos de controle (mantidos)
...
# ============================================================================
# 3.3 INTENÇÕES COGNITIVAS (NOVO MODELO)
# ============================================================================
# <--- NOVO
# Lista de todas as intenções disponíveis
INTENCOES_COGNITIVAS = [
    "entender", "descobrir", "explicar", "ensinar", "comparar",
    "escolher", "recomendar", "corrigir", "resolver", "traduzir",
    "resumir", "listar", "exemplificar", "analisar", "avaliar",
    "criticar", "argumentar", "calcular", "converter", "procurar",
    "localizar", "identificar", "verificar", "confirmar", "validar",
    "estimar", "prever", "planejar", "organizar", "criar",
    "gerar", "escrever", "programar", "instalar", "configurar",
    "comprar", "vender", "viajar", "estudar", "pesquisar",
    "experimentar", "testar", "simular", "modelar", "otimizar",
    "diagnosticar", "tratar", "prevenir", "evitar", "melhorar"
]

# Dicionário de intenção -> lista de iniciadores (mais de 1000 entradas no total)
INTENCOES_PREFIXOS = {
    "entender": [
        "O que é", "Quem é", "Quem foi", "Explique", "Explique melhor",
        "Explique detalhadamente", "Me explique", "Pode explicar",
        "Poderia explicar", "Você consegue explicar", "Você poderia explicar",
        "Gostaria de entender", "Quero entender", "Nunca entendi",
        "Sempre tive dúvida", "Tenho uma dúvida", "Tenho curiosidade",
        "Quero conhecer", "Gostaria de conhecer", "Fale sobre",
        "Conte sobre", "Conte mais", "Me conte", "Gostaria de saber",
        "Pode falar sobre", "Você conhece", "Você sabe", "Pode me dizer",
        "Você poderia me dizer", "Do que se trata", "Em que consiste",
        "O que significa", "O que quer dizer", "Qual o conceito",
        "Qual a definição", "Defina", "Conceitue", "Caracterize",
        "Descreva", "Apresente", "Identifique", "Discorra sobre",
        "Explane", "Esclareça", "Conte tudo sobre", "Quero aprender sobre",
        "Me ensine", "Me ajude a entender", "Ajude-me a compreender",
        "Quero compreender", "Gostaria de compreender", "Poderia esclarecer",
        "Esclareça", "Detalhe", "Aprofunde", "Fale mais", "Conte mais",
        "Me diga mais", "Quero saber mais", "Pode aprofundar",
        "Pode detalhar", "Tenho interesse em", "Sou leigo em",
        "Nunca estudei", "Sempre quis saber", "Gostaria de saber mais",
        "Qual é a definição de", "Como definir", "O que caracteriza",
        "Quais as características de", "Como se define", "O que significa exatamente",
        "Pode me explicar", "Você pode me explicar", "Me dê uma definição de",
        "Quero uma explicação sobre", "Preciso entender", "Preciso compreender",
        "Ainda não entendi", "Não ficou claro", "Poderia repetir",
        "Fale de forma simples", "Explique como se eu fosse leigo",
        "Quero uma visão geral", "Dê uma introdução sobre"
    ],
    "descobrir": [
        "Como descobrir", "Como encontrar", "Onde encontrar", "Como achar",
        "Como identificar", "Como saber", "Como conhecer", "Como explorar",
        "Quero descobrir", "Gostaria de descobrir", "Me ajude a descobrir",
        "Qual a origem de", "Como surgiu", "Quem descobriu", "Quando foi descoberto",
        "O que se sabe sobre", "Há novidades sobre", "Qual a última descoberta",
        "Como pesquisar", "Como investigar", "Como aprofundar", "Como ir além",
        "O que ainda não sei", "O que falta saber", "Como me informar",
        "Onde posso obter mais informações"
    ],
    "explicar": [
        "Explique", "Explique melhor", "Explique detalhadamente", "Explique de forma simples",
        "Explique como se eu fosse criança", "Explique com exemplos", "Explique de maneira clara",
        "Explique passo a passo", "Explique resumidamente", "Explique em detalhes",
        "Pode explicar", "Poderia explicar", "Você pode explicar", "Você poderia explicar",
        "Me explique", "Me explique melhor", "Me explique de outra forma",
        "Gostaria de uma explicação", "Preciso de uma explicação", "Quero uma explicação",
        "Dê uma explicação", "Ofereça uma explicação", "Apresente uma explicação",
        "Como funciona", "Como ocorre", "Como se dá", "Como se processa",
        "Qual a lógica", "Qual o raciocínio", "Qual o fundamento",
        "Por que isso acontece", "Por que é assim", "Qual a razão",
        "Qual o motivo", "Qual a causa", "Quais as causas"
    ],
    "ensinar": [
        "Me ensine", "Quero aprender", "Como aprender", "Como estudar",
        "Como dominar", "Como me tornar um especialista", "Como evoluir",
        "Quais os passos para aprender", "Qual a melhor forma de aprender",
        "O que devo estudar", "Por onde começar", "Quais os pré-requisitos",
        "Como praticar", "Como fixar o conhecimento", "Como não esquecer",
        "Me dê uma aula", "Me dê uma lição", "Me oriente", "Me guie"
    ],
    "comparar": [
        "Compare", "Comparar", "Qual a diferença", "Diferença entre",
        "Semelhança entre", "Analogia", "Comparação", "Qual é melhor",
        "Qual é superior", "Qual é mais indicado", "Qual oferece mais vantagens",
        "Qual é mais eficiente", "Qual é mais barato", "Qual é mais rápido",
        "Quais as vantagens e desvantagens", "Prós e contras", "Pontos fortes e fracos",
        "Como X se compara a Y", "Em que X é diferente de Y",
        "O que X tem que Y não tem", "O que Y tem que X não tem",
        "Qual escolher", "Qual vale mais a pena", "Qual compensa mais",
        "Qual é o mais recomendado", "Qual é o mais usado", "Qual é o mais popular"
    ],
    "escolher": [
        "Qual escolher", "Qual comprar", "O que comprar", "Qual recomenda",
        "Qual vale a pena", "Qual compensa", "Qual é mais indicado",
        "Qual devo usar", "Qual devo adquirir", "O que você indica",
        "O que você recomenda", "Qual apresenta melhor desempenho",
        "Qual possui mais vantagens", "Qual oferece melhor custo-benefício",
        "Qual é o mais confiável", "Qual é o mais seguro", "Qual é o mais durável",
        "Qual é o mais fácil de usar", "Qual é o mais versátil",
        "Entre X e Y, qual prefere", "Qual atende melhor minhas necessidades",
        "Qual solução é melhor", "Qual caminho seguir", "Qual opção é mais adequada"
    ],
    "recomendar": [
        "O que você recomenda", "Qual sua recomendação", "Pode sugerir",
        "Qual a melhor opção", "Qual é o melhor", "Qual é o mais indicado",
        "Me indique", "Me sugira", "Me aconselhe", "Dê uma sugestão",
        "Qual profissional contratar", "Qual serviço usar", "Qual produto comprar",
        "Qual lugar visitar", "Qual curso fazer", "Qual livro ler",
        "Qual filme assistir", "Qual série maratonar", "Qual música ouvir",
        "Qual restaurante ir", "Qual destino viajar"
    ],
    "corrigir": [
        "Como corrigir", "Como consertar", "Como reparar", "Como resolver",
        "Como arrumar", "Como ajustar", "Como regular", "Como calibrar",
        "O que está errado", "Por que deu erro", "Como evitar o erro",
        "Como recuperar", "Como restaurar", "Como voltar ao normal",
        "Como eliminar o problema", "Como remover o defeito",
        "Como solucionar a falha", "Como diagnosticar o erro",
        "Qual a causa do problema", "Qual a origem do defeito"
    ],
    "resolver": [
        "Como resolver", "Como solucionar", "Como lidar com", "Como enfrentar",
        "Como superar", "Como contornar", "Como driblar", "Como evitar",
        "Qual a solução", "Qual a saída", "Qual a alternativa",
        "O que fazer", "O que fazer quando", "Qual a melhor estratégia",
        "Como agir", "Como proceder", "Como reagir", "Como responder",
        "Como se preparar", "Como se prevenir", "Como se proteger"
    ],
    "traduzir": [
        "Como traduzir", "O que significa em português", "O que quer dizer",
        "Qual a tradução", "Traduza", "Pode traduzir", "Me traduza",
        "O equivalente em português", "Como se diz em português",
        "Qual o termo em português", "Como se chama em português"
    ],
    "resumir": [
        "Resuma", "Faça um resumo", "Dê um resumo", "Em resumo",
        "Sintetize", "Condense", "Abrevie", "Resuma em poucas palavras",
        "Qual a essência", "Qual o principal", "Qual o ponto central",
        "Quais os pontos-chave", "Quais as ideias principais",
        "Pode resumir", "Poderia resumir", "Me dê um resumo",
        "Quero um resumo", "Preciso de um resumo"
    ],
    "listar": [
        "Liste", "Enumere", "Quais são", "Quais os tipos",
        "Quais as categorias", "Quais as opções", "Quais as possibilidades",
        "Quais os exemplos", "Quais os casos", "Quais as situações",
        "Quais os fatores", "Quais os elementos", "Quais os componentes",
        "Quais os passos", "Quais as etapas", "Quais as fases",
        "Quais os requisitos", "Quais as condições", "Quais as restrições"
    ],
    "exemplificar": [
        "Dê exemplos", "Exemplifique", "Ilustre", "Mostre com exemplos",
        "Quais exemplos", "Pode dar exemplos", "Me dê exemplos",
        "Exemplo prático", "Caso concreto", "Situação real",
        "Como funciona na prática", "Como se aplica", "Onde é usado"
    ],
    "analisar": [
        "Analise", "Faça uma análise", "Qual a análise", "Como analisar",
        "Quais os fatores a considerar", "Quais os pontos a avaliar",
        "Como interpretar", "Como examinar", "Como dissecar",
        "Quais as implicações", "Quais as consequências", "Quais os efeitos",
        "Quais os impactos", "Quais as tendências", "Quais os padrões"
    ],
    "avaliar": [
        "Avalie", "Qual a avaliação", "Como avaliar", "Como medir",
        "Como quantificar", "Como qualificar", "Qual o critério",
        "Quais os indicadores", "Quais as métricas", "Quais os parâmetros",
        "Como classificar", "Como hierarquizar", "Como ranquear",
        "Qual a nota", "Qual o conceito", "Qual o desempenho"
    ],
    "criticar": [
        "Critique", "Qual a crítica", "Quais as críticas", "O que dizem sobre",
        "Quais as objeções", "Quais as ressalvas", "Quais as limitações",
        "Quais os pontos fracos", "Quais as falhas", "Quais os defeitos",
        "O que pode ser melhorado", "O que deve ser evitado",
        "Qual a controvérsia", "Qual a polêmica"
    ],
    "argumentar": [
        "Argumente", "Qual o argumento", "Quais os argumentos",
        "Qual a tese", "Qual a posição", "Qual a opinião",
        "Por que defender", "Por que contestar", "Como refutar",
        "Como convencer", "Como persuadir", "Como provar",
        "Quais as evidências", "Quais as provas", "Quais os dados"
    ],
    "calcular": [
        "Calcule", "Como calcular", "Qual a fórmula", "Qual a equação",
        "Qual o resultado", "Qual o valor", "Qual a estimativa",
        "Como medir", "Como quantificar", "Como dimensionar",
        "Qual a proporção", "Qual a porcentagem", "Qual a média",
        "Qual a soma", "Qual a diferença", "Qual o produto",
        "Qual a divisão", "Qual a raiz", "Qual a potência"
    ],
    "converter": [
        "Converter", "Como converter", "Qual a conversão", "Qual o fator",
        "Qual a equivalência", "Qual a correspondência", "Como transformar",
        "Como mudar de unidade", "Como passar de", "Como ir de",
        "Qual a taxa de câmbio", "Qual o índice", "Qual a relação"
    ],
    "procurar": [
        "Onde encontrar", "Como achar", "Como localizar", "Como buscar",
        "Como pesquisar", "Como obter", "Como conseguir", "Como adquirir",
        "Onde comprar", "Onde conseguir", "Onde baixar", "Onde assistir",
        "Onde ler", "Onde estudar", "Onde praticar", "Onde se informar"
    ],
    "localizar": [
        "Onde fica", "Como chegar", "Qual o endereço", "Qual a localização",
        "Como ir", "Qual o trajeto", "Qual a rota", "Qual o caminho",
        "Como encontrar", "Como achar", "Como localizar", "Como situar",
        "Qual a distância", "Qual o tempo", "Qual o meio de transporte"
    ],
    "identificar": [
        "Identifique", "Como identificar", "Como reconhecer", "Como distinguir",
        "Como caracterizar", "Como classificar", "Como categorizar",
        "Quais os sinais", "Quais os sintomas", "Quais os indícios",
        "Quais as marcas", "Quais os traços", "Quais as propriedades"
    ],
    "verificar": [
        "Verifique", "Como verificar", "Como checar", "Como conferir",
        "Como validar", "Como confirmar", "Como testar", "Como experimentar",
        "Como ter certeza", "Como garantir", "Como assegurar",
        "Quais os procedimentos", "Quais os protocolos", "Quais os padrões"
    ],
    "confirmar": [
        "Confirme", "Como confirmar", "Como ter certeza", "Como saber",
        "Como comprovar", "Como atestar", "Como certificar", "Como validar",
        "Qual a fonte", "Qual a referência", "Qual a evidência",
        "É verdade", "É correto", "É preciso", "É exato"
    ],
    "validar": [
        "Valide", "Como validar", "Como autenticar", "Como legalizar",
        "Como oficializar", "Como certificar", "Como reconhecer",
        "Qual o processo", "Qual a burocracia", "Qual a documentação",
        "Quais os requisitos", "Quais as exigências", "Quais as normas"
    ],
    "estimar": [
        "Estime", "Como estimar", "Qual a estimativa", "Qual a previsão",
        "Qual a projeção", "Qual a tendência", "Qual o cenário",
        "Como aproximar", "Como calcular", "Como medir", "Como avaliar",
        "Qual a margem", "Qual a incerteza", "Qual o intervalo"
    ],
    "prever": [
        "Preveja", "Como prever", "Qual a previsão", "Qual o prognóstico",
        "Qual o futuro", "Qual o próximo passo", "Como antecipar",
        "Como se preparar", "Como se prevenir", "Como se planejar",
        "Quais os riscos", "Quais as oportunidades", "Quais os desafios"
    ],
    "planejar": [
        "Planeje", "Como planejar", "Qual o plano", "Qual a estratégia",
        "Qual o roteiro", "Qual o cronograma", "Qual o orçamento",
        "Como organizar", "Como estruturar", "Como coordenar",
        "Quais os passos", "Quais as etapas", "Quais os recursos",
        "Como definir metas", "Como estabelecer prioridades"
    ],
    "organizar": [
        "Organize", "Como organizar", "Como estruturar", "Como arrumar",
        "Como sistematizar", "Como catalogar", "Como classificar",
        "Como ordenar", "Como sequenciar", "Como hierarquizar",
        "Como agrupar", "Como separar", "Como categorizar"
    ],
    "criar": [
        "Crie", "Como criar", "Como inventar", "Como produzir",
        "Como desenvolver", "Como construir", "Como elaborar",
        "Como conceber", "Como idealizar", "Como projetar",
        "Como gerar", "Como originar", "Como fazer nascer",
        "Quais as técnicas", "Quais as ferramentas", "Quais os materiais"
    ],
    "gerar": [
        "Gere", "Como gerar", "Como produzir", "Como fabricar",
        "Como obter", "Como extrair", "Como coletar", "Como reunir",
        "Como sintetizar", "Como compilar", "Como agregar",
        "Como transformar", "Como converter", "Como processar"
    ],
    "escrever": [
        "Escreva", "Como escrever", "Como redigir", "Como compor",
        "Como elaborar", "Como produzir", "Como criar",
        "Qual o estilo", "Qual o tom", "Qual a estrutura",
        "Como começar", "Como desenvolver", "Como concluir",
        "Quais as dicas", "Quais os erros a evitar", "Quais os truques"
    ],
    "programar": [
        "Programe", "Como programar", "Como codificar", "Como desenvolver",
        "Como implementar", "Como testar", "Como depurar",
        "Qual a linguagem", "Qual o framework", "Qual a biblioteca",
        "Como estruturar o código", "Como otimizar", "Como versionar"
    ],
    "instalar": [
        "Instale", "Como instalar", "Como configurar", "Como preparar",
        "Como montar", "Como colocar", "Como implantar",
        "Como desinstalar", "Como remover", "Como desconfigurar",
        "Quais os pré-requisitos", "Quais os cuidados", "Quais os passos"
    ],
    "configurar": [
        "Configure", "Como configurar", "Como ajustar", "Como personalizar",
        "Como adaptar", "Como modificar", "Como alterar",
        "Como parametrizar", "Como calibrar", "Como regular",
        "Como otimizar", "Como melhorar", "Como corrigir",
        "Quais as opções", "Quais as preferências", "Quais as variáveis"
    ],
    "comprar": [
        "Onde comprar", "Como comprar", "Qual o preço", "Quanto custa",
        "Qual o valor", "Qual a melhor oferta", "Qual o desconto",
        "Qual a loja", "Qual o site", "Qual a marca",
        "Como pagar", "Como parcelar", "Como receber",
        "Qual a garantia", "Qual a política de devolução"
    ],
    "vender": [
        "Como vender", "Onde vender", "Como anunciar", "Como divulgar",
        "Como precificar", "Como negociar", "Como fechar negócio",
        "Qual o público-alvo", "Qual a estratégia", "Qual o canal",
        "Como atrair clientes", "Como fidelizar", "Como pós-venda"
    ],
    "viajar": [
        "Viajar para", "Como viajar", "Qual o destino", "Qual a rota",
        "Qual o transporte", "Qual a hospedagem", "Qual a alimentação",
        "Quais os pontos turísticos", "Quais os cuidados", "Qual o clima",
        "Qual a moeda", "Qual o idioma", "Qual a cultura",
        "Como se planejar", "Como economizar", "Como aproveitar"
    ],
    "estudar": [
        "Estudar", "Como estudar", "Qual a matéria", "Qual o conteúdo",
        "Qual o livro", "Qual o curso", "Qual a plataforma",
        "Como se concentrar", "Como memorizar", "Como revisar",
        "Como organizar os estudos", "Como fazer anotações",
        "Como resolver exercícios", "Como se preparar para provas"
    ],
    "pesquisar": [
        "Pesquisar", "Como pesquisar", "O que pesquisar", "Como buscar",
        "Onde buscar", "Como filtrar", "Como selecionar",
        "Quais as fontes", "Quais os critérios", "Quais as melhores práticas",
        "Como interpretar os resultados", "Como validar", "Como citar"
    ],
    "experimentar": [
        "Experimente", "Como experimentar", "Como testar", "Como provar",
        "Como vivenciar", "Como sentir", "Como perceber",
        "Qual a sensação", "Qual a experiência", "Qual o resultado",
        "Vale a pena experimentar", "O que esperar"
    ],
    "testar": [
        "Teste", "Como testar", "Como verificar", "Como validar",
        "Como experimentar", "Como provar", "Como analisar",
        "Como medir", "Como avaliar", "Como diagnosticar",
        "Quais os testes", "Quais os parâmetros", "Quais os critérios"
    ],
    "simular": [
        "Simule", "Como simular", "Como modelar", "Como reproduzir",
        "Como replicar", "Como emular", "Como prever",
        "Qual o cenário", "Qual a condição", "Qual a variável",
        "Como criar um modelo", "Como rodar uma simulação"
    ],
    "modelar": [
        "Modele", "Como modelar", "Como representar", "Como formalizar",
        "Como abstrair", "Como simplificar", "Como estruturar",
        "Como construir", "Como refinar", "Como validar",
        "Quais as técnicas", "Quais as ferramentas"
    ],
    "otimizar": [
        "Otimize", "Como otimizar", "Como melhorar", "Como aperfeiçoar",
        "Como refinar", "Como aprimorar", "Como maximizar",
        "Como minimizar", "Como balancear", "Como equilibrar",
        "Quais os gargalos", "Quais as oportunidades", "Quais as soluções"
    ],
    "diagnosticar": [
        "Diagnostique", "Como diagnosticar", "Como identificar o problema",
        "Como descobrir a causa", "Como analisar os sintomas",
        "Como interpretar os sinais", "Como avaliar a situação",
        "Quais as possíveis causas", "Qual a origem", "Qual o diagnóstico"
    ],
    "tratar": [
        "Como tratar", "Qual o tratamento", "Como curar", "Como aliviar",
        "Como controlar", "Como gerenciar", "Como lidar",
        "Qual a terapia", "Qual o medicamento", "Qual a cirurgia",
        "Quais os cuidados", "Quais as contraindicações", "Qual a eficácia"
    ],
    "prevenir": [
        "Como prevenir", "Como evitar", "Como se proteger", "Como se precaver",
        "Como se cuidar", "Como se antecipar", "Como se preparar",
        "Quais os fatores de risco", "Quais os cuidados diários",
        "Qual a vacina", "Qual o exame", "Qual o hábito saudável"
    ],
    "evitar": [
        "Como evitar", "Como escapar", "Como fugir", "Como se livrar",
        "Como se prevenir", "Como se proteger", "Como contornar",
        "Como driblar", "Como superar", "Como vencer",
        "Quais as armadilhas", "Quais os erros comuns", "O que não fazer"
    ],
    "melhorar": [
        "Como melhorar", "Como evoluir", "Como progredir", "Como desenvolver",
        "Como aperfeiçoar", "Como aprimorar", "Como refinar",
        "Como otimizar", "Como aumentar", "Como reduzir",
        "Como acelerar", "Como desacelerar", "Como equilibrar",
        "Quais as técnicas", "Quais os treinos", "Quais as dicas"
    ],
}

# Mapeamento opcional de categoria -> intenções preferenciais (para dar peso)
MAPA_INTENCOES_PREFERENCIAIS = {
    "objeto": ["entender", "descobrir", "comparar", "escolher", "comprar", "instalar"],
    "lugar": ["entender", "descobrir", "localizar", "viajar", "planejar"],
    "pessoa": ["entender", "descobrir", "explicar", "analisar", "criticar"],
    "sentimento": ["entender", "explicar", "analisar", "tratar", "prevenir"],
    "conceito": ["entender", "explicar", "analisar", "comparar", "resumir"],
    "conhecimento": ["entender", "explicar", "ensinar", "pesquisar", "estudar"],
    "profissao": ["entender", "descobrir", "comparar", "escolher", "recomendar"],
    "arte_cultura": ["entender", "descobrir", "explicar", "analisar", "criticar"],
    "ciencia_tecnologia": ["entender", "descobrir", "explicar", "programar", "instalar"],
    "acao": ["entender", "aprender", "praticar", "corrigir", "melhorar"],
    "alimento": ["entender", "descobrir", "comparar", "comprar", "experimentar"],
    "animal": ["entender", "descobrir", "explicar", "analisar", "prevenir"],
    "transporte": ["entender", "descobrir", "comparar", "escolher", "viajar"],
    "sociedade_politica": ["entender", "explicar", "analisar", "argumentar", "criticar"],
    "natureza_universo": ["entender", "descobrir", "explicar", "analisar", "prever"],
    "musica": ["entender", "descobrir", "explicar", "analisar", "criticar"],
    "sintomas_doencas": ["entender", "diagnosticar", "tratar", "prevenir", "evitar"],
    "datas_historicas": ["entender", "descobrir", "explicar", "analisar", "argumentar"],
    "geopolitica": ["entender", "explicar", "analisar", "argumentar", "prever"],
    "ciencia": ["entender", "descobrir", "explicar", "pesquisar", "simular"],
    "historia": ["entender", "descobrir", "explicar", "analisar", "argumentar"],
    "filosofia": ["entender", "explicar", "analisar", "argumentar", "criticar"],
    "literatura": ["entender", "descobrir", "explicar", "analisar", "criticar"],
    "economia": ["entender", "analisar", "prever", "planejar", "otimizar"],
    "esportes": ["entender", "descobrir", "comparar", "praticar", "melhorar"],
    "mitologia": ["entender", "descobrir", "explicar", "analisar", "criticar"],
    "ciencias_sociais": ["entender", "explicar", "analisar", "argumentar", "criticar"],
    "filmes": ["entender", "descobrir", "explicar", "analisar", "criticar"],
    "series": ["entender", "descobrir", "explicar", "analisar", "criticar"],
    "personagens_ficticios": ["entender", "descobrir", "explicar", "analisar", "criticar"],
    "tecnologias_emergentes": ["entender", "descobrir", "explicar", "programar", "instalar"],
    "eventos_historicos_brasil": ["entender", "descobrir", "explicar", "analisar", "argumentar"],
    "mito_brasileiro": ["entender", "descobrir", "explicar", "analisar", "criticar"],
    "cientista_brasileiro": ["entender", "descobrir", "explicar", "analisar", "criticar"],
    "ponto_turistico": ["entender", "descobrir", "localizar", "viajar", "planejar"],
    "festa_popular": ["entender", "descobrir", "explicar", "analisar", "criticar"],
    "esporte_modalidade": ["entender", "descobrir", "comparar", "praticar", "melhorar"],
    "jogo": ["entender", "descobrir", "comparar", "escolher", "experimentar"],
    "marca": ["entender", "descobrir", "comparar", "escolher", "comprar"],
    "ferramenta": ["entender", "descobrir", "comparar", "escolher", "instalar"],
    "conceito_filosofico": ["entender", "explicar", "analisar", "argumentar", "criticar"],
    "conceito_cientifico": ["entender", "descobrir", "explicar", "analisar", "simular"],
}

def classificar_tema(tema: str) -> str:
    """Retorna a categoria (objeto, lugar, pessoa, etc.) do tema."""
...
def escolher_intencao_e_prefixo(categoria: str = None) -> tuple:
    """
    Escolhe uma intenção aleatória da lista global e um prefixo correspondente.
    Se uma categoria for fornecida, dá preferência às intenções recomendadas para ela.
    Retorna (intencao, prefixo).
    """
    # Se categoria for fornecida, tenta escolher uma intenção preferencial com 60% de chance
    if categoria and categoria in MAPA_INTENCOES_PREFERENCIAIS:
        preferidas = MAPA_INTENCOES_PREFERENCIAIS[categoria]
        if random.random() < 0.6:
            intencao = random.choice(preferidas)
        else:
            intencao = random.choice(INTENCOES_COGNITIVAS)
    else:
        intencao = random.choice(INTENCOES_COGNITIVAS)
...
def gerar_pergunta_simples():
    ...
    # Se for uma intenção de comparação, pode gerar uma pergunta com dois assuntos
    if intencao in ["comparar", "escolher"] and random.random() < 0.3:
...
# 11. SALVAMENTO
# ============================================================================
def salvar_texto(texto, prefixo, indice, tipo="dicionario"):
    """Salva o texto na pasta correspondente ao tipo."""
    pasta_nome = PASTA_POR_TIPO.get(tipo, "Outros")
    pasta = os.path.join(PASTA_SAIDA, pasta_nome)
    os.makedirs(pasta, exist_ok=True)
...
def salvar_fallback(texto, prefixo, indice):
    os.makedirs(PASTA_FALLBACKS, exist_ok=True)
    nome = f"{prefixo}_fallback_{indice:06d}.txt"
    caminho = os.path.join(PASTA_FALLBACKS, nome)
    with open(caminho, 'w', encoding='utf-8') as f:
        f.write(f"--- FALLBACK ---\n\n{texto if texto else '(vazio)'}")
    return caminho
...
def _gerar_texto_variavel(tipo, tema, pergunta=None):
    """
    Fallback inteligente: usa a mesma lógica de intenção para gerar uma pergunta
    e tenta a API uma última vez; caso falhe, gera uma resposta local.
    """
    ...
    # Classifica o tema e escolhe intenção
    categoria = classificar_tema(tema_limpo)
    intencao, prefixo = escolher_intencao_e_prefixo(categoria)
    
    # Constrói a pergunta de fallback com a intenção
    if prefixo.endswith("?") or prefixo in ["O que é", "Defina", "Explique", "Resuma",
                                            "Fale mais sobre", "Conte mais sobre", "Gostaria de conhecer", "Quero conhecer"]:
...
def menu_interativo():
    ...
    while True:
        ...
        for i, tipo in enumerate(tipos_menu, 1):
            pasta = PASTA_POR_TIPO.get(tipo, "Outros")
            desc = {
                "dicionario": "pergunta + resposta curta",
                "pergunta_resposta": "longa ★",
                "iteracao": "diálogo 5-8 turnos",
                "artigo": "estruturado 500-900 palavras ★★",
                "conto": "história curta 400-700 ★★★",
                "dialogo_profundo": "10-15 turnos ★★★★★",
                "explicacao": "detalhada 350-600 palavras",
                "resumo": "síntese concisa 200-400",
                "conversa": "diálogo, min 250 palavras",
                "saudacao": "prontas, sem custo",
                "poema": "10-20 versos",
                "carta": "formal/informal",
                "entrevista": "5-8 perguntas",
                "debate": "pró e contra",
                "tutorial": "passo a passo ✨ NOVO",
                "resenha": "crítica ✨ NOVO",
                "relatorio": "técnico ✨ NOVO",
                "ensaio": "reflexivo ✨ NOVO",
                "cronica": "texto literário ✨ NOVO",
                "receita": "culinária ✨ NOVO",
                "dica": "conselho rápido ✨ NOVO"
            }.get(tipo, tipo.replace('_', ' ').title())
            print(f"  {i:2d}. {desc:30} -> {pasta}")
        ...
        if tipo == "auto":
            # Modo automático (código mantido igual)
...
def executar_geracao(args):
    ...
    with tqdm(total=args.quantidade, desc="Gerando", unit="item") as pbar:
        while total_gerados < args.quantidade:
            ...
            # O sexto valor de retorno é a flag is_fallback
            texto, custo, tokens_in, tokens_out, _, is_fallback, finish_reason = gerar_dialogo(
            ...
            # Se for fallback, salva na pasta de fallbacks
    ...
    print(f"   🗑️  Descartados salvos em: {PASTA_DESCARTES}/")
    if is_fallback in ("fallback", "fallback_api"):
        print(f"   ⚠️  Fallbacks salvos em: {PASTA_FALLBACKS}/")
    if motivos:
...
def gerar_lote(tipo, quantidade, prefixo,
    ...
    # --- BARRA DE PROGRESSO COM FORMATO PERSONALIZADO ---
    with tqdm(total=quantidade, desc=f">> {tipo} >>", unit="item",
              bar_format="{desc}: {n_fmt}/{total_fmt} itens, {rate_fmt}, {elapsed}<{remaining}") as pbar:
        while total_gerados < quantidade:
            ...
            # Salva de acordo com o tipo ou fallback
            if is_fallback in ("fallback", "fallback_api"):
            ...
            pbar.set_description(
                f">> {tipo} >> tipo {total_gerados} itens gerados com sucesso, "
                f"{total_descartes} itens descartados, "
                f"{pbar.format_dict['elapsed']}, "
                f"{pbar.format_dict['rate']:.2f}s por item, "
                f"custo=${estado_dialogos['custo_total']:.4f}"
            )
